...
const TEXT_TRANSLATIONS: Record<string, string> = {
  ...
  'What makes Meetily different': 'MinuteFlow 的不同之处',
  'Privacy-first': '隐私优先',
  ...
  'Welcome to meetily!': '欢迎使用 MinuteFlow！',
  ...
  'View and access where Meetily stores your data': '查看并访问 MinuteFlow 存储数据的位置',
